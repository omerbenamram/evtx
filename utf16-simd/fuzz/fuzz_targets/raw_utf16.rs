...
use utf16_simd::{escape_utf16_raw, escape_utf16_raw_scalar, max_escaped_len};
...
fuzz_target!(|data: &[u8]| {
    ...
    let len_simd = escape_utf16_raw(&utf16, &mut out_simd);
    let len_scalar = escape_utf16_raw_scalar(&utf16, &mut out_scalar);
